                            ...
                            <tbody>
                                @foreach ($users as $key => $user)
                                    <tr>
                                        ...
                                        <td>{{ ($user->login_time!=null)? Carbon\Carbon::parse($user->login_time)->format('h:i:s'):"" }}</td>
                                        <td>{{ (($user->is_login==1)&&$user->logout_time!=null)? Carbon\Carbon::parse($user->logout_time)->format('h:i:s'):"" }}</td>
