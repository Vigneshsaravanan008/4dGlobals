                        ...
                        <form method="POST" action="{{ route('user.store') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('phone_no') is-invalid @enderror"
                                    id="phoneNumber" name="phone_no"value="{{ old('phone_no') }}" required>
                                @error('phone_no')
                                    <div class="invalid-feedback animated fadeIn">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('department_id') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('department_id') == 1 ? 'selected' : '' }}>HR</option>
                                    <option value="2" {{ old('department_id') == 2 ? 'selected' : '' }}>Software
                                    </option>
                                    <option value="3" {{ old('department_id') == 3 ? 'selected' : '' }}>IT</option>
                                </select>
                                @error('department_id')
                                    <div class="invalid-feedback animated fadeIn">{{ $message }}</div>
                                @enderror
